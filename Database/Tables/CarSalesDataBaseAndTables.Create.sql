...
/****** Object:  Table [dbo].[Enquiry]    Script Date: 7/09/2018 10:08:38 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[Enquiry]  WITH CHECK ADD  CONSTRAINT [FK_Car_Enquiry] FOREIGN KEY([CarId])
REFERENCES [dbo].[AdvertisedCars] ([ID])
GO

ALTER TABLE [dbo].[Enquiry] CHECK CONSTRAINT [FK_Car_Enquiry]
GO
